---
layout: post
title: "[Elasticsearch] Elasticsearch 8 설치 및 테스트"
excerpt: Elasticsearch 8를 설치하고 테스트한다.
categories:
    - Elasticsearch
...
&nbsp; 먼저 [Elasticsearch 다운로드 페이지](https://www.elastic.co/kr/downloads/elasticsearch)에 가서 운영체제에 맞는 파일을 받는다. 22/5/16 현재 최신판은 8.2.0

![Elasticsearch download](/images/elasticsearch_down.jpeg)
...
![node name changed](/images/Screenshot%20from%202022-05-17%2000-33-01.png)
